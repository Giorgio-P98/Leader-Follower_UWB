...
static const _Uwb_type_support_symbol_names_t _Uwb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mymsg_msgs, msg, Uwb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsg_msgs, msg, Uwb)),
  }
};
...
{
  return &::mymsg_msgs::msg::rosidl_typesupport_cpp::Uwb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mymsg_msgs, msg, Uwb)() {
  return get_message_type_support_handle<mymsg_msgs::msg::Uwb>();
}
